...
var PhysicsScene = function (_Scene) {
  ...
  _createClass(PhysicsScene, [{
    ...
    value: function applyGravity() {
      this.sound.alternatePad((0, _key.isKeyDown)('Space'));
...
var ProceduralMelody = function () {
  function ProceduralMelody(scale) {
    _classCallCheck(this, ProceduralMelody);
  ...
  _createClass(ProceduralMelody, [{
    key: 'getNote',
    value: function getNote() {
      var note = this.scale.stepToFrequency(this.scale.steps[this.scaleIndex]);
...
var Pad = function () {
  ...
  _createClass(Pad, [{
    ...
    value: function setAlternate(alt) {
      var freq0 = this.scale.stepToFrequency(this.scale.steps[alt ? 0 : 2]) / 2;
      if (this.vcos[0].osc.frequency.value !== freq0) this.vcos[0].setFrequency(freq0);

      var freq1 = this.scale.stepToFrequency(this.scale.steps[alt ? 4 : 5]) / 2;
      if (this.vcos[1].osc.frequency.value !== freq1) this.vcos[1].setFrequency(freq1);
    }
  }, {
    key: 'setFrequencies',
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.3ae969f4697f7f73bb82.js.map